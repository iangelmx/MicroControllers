...
;; 6 Mensaje: ;Se manda un HOLA
	...
	;; H:
	; 4_ para la H y 8 para la señal RS.
	;Parte alta:	
	...
	; _8 para la H y 8 para la señal RS.
	ldi temp, $88
	out portd, temp
	...
	;; O:
	; 4_ para la O y 8 para la señal RS.
	;Parte alta:	
	...
	; _F para la O y 8 para la señal RS.
	ldi temp, $F8
	out portd, temp
	...
	;; L:
	; 4_ para la L y 8 para la señal RS.
	;Parte alta:	
	...
	; _C para la L y 8 para la señal RS.
	ldi temp, $C8
	out portd, temp
	...
	;; A:
	; 4_ para la A y 8 para la señal RS.
	;Parte alta:	
	ldi temp, $48 ;Para la L
	out portd, temp
	...
	; _1 para la A y 8 para la señal RS.
	ldi temp, $18
	out portd, temp
